<template>
	<view class="u-numberbox">
		<view class="u-icon-minus" @click.stop.prevent="btnTouchStart('minus')"  @touchstart.stop.prevent="btnTouchStart('minus')"@touchend.stop.prevent="clearTimer" :class="{ 'u-icon-disabled': disabled || inputVal <= min }"
		    :style="{
				background: bgColor,
		...
		<input :disabled="disabledInput || disabled" :cursor-spacing="getCursorSpacing"  :class="{ 'u-input-disabled': disabled }"
		    v-model.number="inputVal" class="u-number-input" @blur.stop.prevent="onBlur" 
		    type="number" :style="{
				color: color,
				fontSize: size + 'rpx',
				background: bgColor,
		...
		<view class="u-icon-plus" @click.stop.prevent="btnTouchStart('plus')"  @touchstart.stop.prevent="btnTouchStart('plus')"  @touchend.stop.prevent="clearTimer" :class="{ 'u-icon-disabled': disabled || inputVal >= max }"
		    :style="{
				background: bgColor,
				height: inputHeight + 'rpx',
				color: color
